...
//     **/
//
//    inline fun <reified T> getObject(key: String): T? {        //We read JSON String which was saved.
...
//
//    fun getCoins() : Int {
//        return sharedPref.getInt(COINS_COUNT,0)
//    }
//    fun setCoins(coin: Int) {
//        editor.putInt(COINS_COUNT,coin)
//        editor.apply()
//    }
//
//}
